...
let zucchini = garden["vegetable"]; // we can access keys in an object by specifying the name of the object we want to reference, followed by the keys named in square brackets. The key name we passed into the square brackets needs to be wrapped in quotes since all keys in objects are strings.
...
console.log(baking[garden["vegetable"]]); // [garden["vegetable"]] evaluates to "zucchini" and baking["zucchini"] evaluates to "better make some bread"; which is the FINAL output
