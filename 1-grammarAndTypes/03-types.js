...
/*
    NULL
        - null is an empty value. Think of it as an empty container: nothing is in it,
        but it still exists as a space to fill
...
/* 
    NUMBERS
        ...
        - numbers/ integers do not need anything special when being written
*/
...
/*
    - when javascript sees that we're tring to add together a number and a string, instead of using the built in math functionality, it will instead use concatenation to combine the values instead of trying to synthesize the values.
*/
console.log(third);
...
/*
    ARRAYS
        - arrays are containters that hold a list of items
